        ...
        <>
            ...
            <div className='transparent-panel mb-6'>
                <div className="grid sm:grid-cols-3 gap-4 text-center">
                    <ButtonLink color={'secondary'} href={'https://mesaderegalos.liverpool.com.mx/'} growX >
                    ...
                    <ButtonLink color={'secondary'} href={'https://www.amazon.com.mx/registries/custom'} growX >
                        <div className="flex flex-col justify-center items-center my-2">
                            <img className="h-9 max-w-full mb-1" src="/img/amazon_logo.svg" alt="Logo de Liverpool" />
                            <p>Mesa de Regalos</p>
                        </div>
                    </ButtonLink>
                    <Button color={'secondary'} growX >
                        <div className="flex flex-col justify-center items-center my-2">
            ...
            <div className="transparent-panel overflow-hidden cursor-pointer" onClick={() => setShowBankAccountData(!showBankAccountData)}>
                ...
                <Dropdown isOpen={showBankAccountData}>
                    <div className="pt-4 cursor-auto justify-center" onClick={(e) => e.stopPropagation()}>
                        <div className="mb-2 sm:flex items-center">
                            <p className="me-1 font-semibold">Banco:</p>
                            <span className="mark-secondary text-sm"><img className="h-[1rem]" src="/img/bank-logos/banorte_logo.svg" alt="Banorte Logo" /></span>
                        </div>
                        <div className="mb-2 sm:flex items-center">
